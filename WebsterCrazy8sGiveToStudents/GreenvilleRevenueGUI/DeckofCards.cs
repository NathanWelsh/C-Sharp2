...
namespace GreenvilleRevenueGUI
{
    ...
    class Cards
    {
        ...
        public void checkdeckofcards()
        {
            ...
            for (int index = 0; index < 15; index++)
            {
                msg = " card value is : " + index + " count is : " + histogram[index];
            ...
            {
                int value = AllCards[index].GetCardValue();
                String Svalue = AllCards[index].GetValueasString(value);

                String suit = AllCards[index].GetSuitasString();
                // msg = msg + "i: " + index + " value is : " + Svalue + " of " + suit + "\n";
                msg = "i: " + index + " value is : " + Svalue + " of " + suit;
        ...
        public void ResetCardsDiscarded()
        {
            ...
            for (int index = 0; index < 52; index++)
            {
                AllCards[index].Setdiscarded(false);
            }
        }
